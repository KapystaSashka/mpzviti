...
class User(db.Model):
    ...
    position   = db.Column(db.String(128), nullable=False, default="")
    gender     = db.Column(db.String(8),   nullable=False, default="M")
...
def seed_db():
    ...
    if not Event.query.first():
        events = [
            ...
            Event(title="Військово-історичний лекторій для курсантів",                        date="2026-06-15", location="Лекційний зал №2",       responsible="підполковник Шевченко А.П.", status="Заплановано", category="educational",   unit_id=1,    attendance=0,   capacity=60,  satisfaction_score=0.0),
            ...
            Event(title="Тренінг з психологічної реабілітації",                               date="2026-06-20", location="Клас 215",               responsible="капітан Ковальчук О.І.",    status="Заплановано", category="psychological", unit_id=None, attendance=0,   capacity=25,  satisfaction_score=0.0),
            Event(title="День фізичної підготовки — естафета",                                date="2026-06-22", location="Спортивний майданчик",   responsible="майор Петренко В.М.",        status="Заплановано", category="sport",         unit_id=2,    attendance=0,   capacity=50,  satisfaction_score=0.0),
